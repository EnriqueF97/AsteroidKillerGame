  ...
  if (!gameOver && !pause) {
    ...
    if (movingUp) {
      if (sphereGun.rotation.x < 4.5) {
        if (!slowMoving) {
          sphereGun.rotation.x += angle * cannonRotationSpeed;
        }
        if (slowMoving) {
          sphereGun.rotation.x += (angle * cannonRotationSpeed) / 4;
        }
      }
    }
    if (movingDown) {
    ...
    if (movingLeft) {
      if (!slowMoving) {
        movingGun.rotation.y += angle * cannonRotationSpeed;
      }
      if (slowMoving) {
        movingGun.rotation.y += (angle * cannonRotationSpeed) / 4;
      }
    }
    if (movingRight) {
      if (!slowMoving) {
